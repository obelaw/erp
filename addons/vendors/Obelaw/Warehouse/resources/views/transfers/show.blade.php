                ...
                <div class="card-body">
                    <div class="datagrid mb-3">
                        <div class="datagrid-item">
                            ...
                            <div class="datagrid-content">{{ $transfer->inventoryFrom->name ?? '--' }}</div>
                        </div>
                        <div class="datagrid-item">
                            <div class="datagrid-title">
                            ...
                            <div class="datagrid-content">{{ $transfer->inventoryTo->name }}</div>
                        </div>
                        <div class="datagrid-item">
                            <div class="datagrid-title">Transfer Type</div>
                            <div class="datagrid-content">{{ $transfer->type }}</div>
                        </div>
                        <div class="datagrid-item">
                            <div class="datagrid-title">Transfer quantity</div>
                            <div class="datagrid-content">{{ $transfer->quantity }}</div>
                        </div>
                    </div>
                    ...
                    <div class="datagrid">
                        <div class="datagrid-item">
                            ...
                            <div class="datagrid-content">{{ $transfer->product->name }} ({{ $transfer->product->sku }})</div>
                        </div>
                        <div class="datagrid-item">
                            <div class="datagrid-title">Transfer description</div>
